-- Modified: https://github.com/LunarVim/starter.lvim/tree/rust-ide
-- :MasonInstall
...
lvim.builtin.which_key.mappings["C"] = {
    ...
    i = {
        "<cmd>lua require'crates'.show_crate_popup()<cr>", "[crates] show info"
    },
    f = {
...
if this_os:find "Windows" then
    codelldb_path = mason_path ..
                        "packages\\codelldb\\extension\\adapter\\codelldb.exe"
    liblldb_path = mason_path ..
                       "packages\\codelldb\\extension\\lldb\\bin\\liblldb.dll"
else
